...
class DocLayNet(BaseModel):
    ...
    path: ClassVar[Path] = dataset.path / "DocLayNet"
...
class D4LA(BaseModel):
    ...
    path: ClassVar[Path] = dataset.path / "D4LA"
...
class DocGenome(BaseModel):
    ...
    path: ClassVar[Path] = dataset.path / "DocGenome"
...
class DocSynth300K(BaseModel):
    ...
    path: ClassVar[Path] = dataset.path / "DocSynth300K"
